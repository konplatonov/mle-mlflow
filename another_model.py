...
EXPERIMENT_NAME = "my_own_experiment_V3"
...
with mlflow.start_run(run_name=RUN_NAME, experiment_id=experiment_id) as run:
    ...
    mlflow.register_model(model_uri, "AnotherRandomForestModel")
    ...
    input_schema = Schema([ColSpec("double", name) for name in X.columns])
    ...
    mlflow.log_artifact("train.py", artifact_path="code")

    mlflow.log_artifact("users_churn.csv", artifact_path="input")
